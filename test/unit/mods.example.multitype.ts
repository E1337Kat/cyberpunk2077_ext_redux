...
const ValidTypeCombinations = new Map<string, ExampleSucceedingMod>(
  Object.entries({
    ...
    "MultiType: Redscript + Archive Canonical": {
      expectedInstallerType: InstallerType.MultiType,
      inFiles: [
        ...REDS_PREFIXES,
        path.join(`${REDS_PREFIX}/rexmod/`),
    ...
    "MultiType: CET + Archive Canonical": {
      expectedInstallerType: InstallerType.MultiType,
      inFiles: [
        ...CET_PREFIXES,
        path.join(`${CET_PREFIX}/exmod/`),
...
const MultiTypeWithREDmodSuccesses = new Map<string, ExampleSucceedingMod>([
  ...
  [
    `MultiType: REDmod maybe with archive installable with old-style archive + CET`,
    {
      expectedInstallerType: InstallerType.MultiType,
      fsMocked: mockedFsLayout(
        {
  ...
  [
    `MultiType: REDmod maybe with archive installable with old-style archive. This is dumb.`,
    {
      expectedInstallerType: InstallerType.MultiType,
      fsMocked: mockedFsLayout(
        {
