  ...
  Object.entries({
    ...
    red4extWithRedScriptEmbeddedCanonical: {
      ...
      inFiles: [
        ...
        path.join(`${RED4EXT_PREFIX}/r4emod/blarghive.archive`),
        path.join(`${RED4EXT_PREFIX}/r4emod/blarghive.archive.xl`),
        path.join(`${RED4EXT_PREFIX}/r4emod/archives/schmarkives.archive`),
        path.join(`${RED4EXT_PREFIX}/r4emod/tweaks/tweakytweak.tweak`),
        path.join(`${RED4EXT_PREFIX}/r4emod/tweaks/tweakytweak.yaml`),
        path.join(`${RED4EXT_PREFIX}/r4emod/tweaks/tweakytweak.yml`),
      ],
      outInstructions: [
        ...pipe(
          [
